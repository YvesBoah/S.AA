                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="center-heading">
                            <h2 class="section-title">Créer une fiche client !</h2>
                        </div>
                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                          <span>
                                            <strong>Votre nom</strong>
                                             ...
                                             <input type="text" placeholder="Votre nom" class="form-control{{ $errors->has('nom') ? ' is-invalid' : '' }}" name="nom" value="{{ old('nom') }}" >
                                              @if ($errors->has('nom'))
                                            <span class="invalid-feedback" role="alert">
                            ...
                            <!-- Seconde ligne -->
                                <div class="row">  
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                          <span>
                                            <strong>Votre prénom</strong>
                                             ...
                                             <input type="text" placeholder="Votre prénom" class="form-control{{ $errors->has('prenom') ? ' is-invalid' : '' }}" name="prenom" value="{{ old('prenom') }}" >
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <input type="number" placeholder="Telephone" class="form-control{{ $errors->has('telephone') ? ' is-invalid' : '' }}" name="telephone" >
                                    ...
                                    <div class="col-lg-4 col-md-12 col-sm-12">
                                        ...
                                        <input type="text" placeholder="ville de résidence" class="form-control{{ $errors->has('ville') ? ' is-invalid' : '' }}" name="ville" >
                                        @if ($errors->has('ville'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="row">  
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                     ...
                                     {{-- Algorithme d'ordonnacement des numéros clients --}} 
                            <?php 
                                ...
                                if (count($Client) < 10){
                                 ...
                                 if (count($Client) >10  && count($Client)<100){
                                    $a ='000000';
                                }

                                 if (count($Client) >100  && count($Client)<1000){
                                    $a ='00000';
                                }

                                if (count($Client) >1000  && count($Client)<10000){
                                    $a ='0000';
                                }

                                if (count($Client) >10000  && count($Client)<100000){
                                    $a ='000';
                                }

                                if (count($Client) >100000  && count($Client)<1000000){
                                    $a ='00';
                                }

                                if (count($Client) >1000000  && count($Client)<10000000){
                                    $a = '0';
                                }

                                if (count($Client) >10000000  && count($Client)<100000000){
                                    $a = NULL;
                                }
                                    $b = count($Client)+1;
                                    // echo $a.$b;
                                ...
                                <input type="hidden" name="rang" class="form-control{{ $errors->has('numero_client') ? ' is-invalid' : '' }}" value="<?php echo $a.$b ?>">
